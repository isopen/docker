...
В будующем лучше всего по каждой табличке не лениться и звонить в Microsoft (например которые возникают в правом нижнем углу экрана).<br>
Этот шаг добавит чуточку прогресса в улучшении Windows 10 до Windows 7.
