...
<code>Could not find Windows SDK. [#20](https://github.com/tdlib/td/issues/20) </code> [Скачать и установить](https://developer.microsoft.com/en-us/windows/downloads/windows-10-sdk)<br><br>
